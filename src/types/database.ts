  ...
  public: {
    Tables: {
      ...
      job_site_roster: {
        ...
        Relationships: [
          {
            foreignKeyName: "job_site_roster_job_site_id_fkey";
            columns: ["job_site_id"];
            isOneToOne: false;
            referencedRelation: "job_sites";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "job_site_roster_staff_id_fkey";
            columns: ["staff_id"];
            isOneToOne: false;
            referencedRelation: "staff";
            referencedColumns: ["id"];
      ...
      job_site_tasks: {
        ...
        Relationships: [
          {
            foreignKeyName: "job_site_tasks_assigned_staff_id_fkey";
          ...
          {
            foreignKeyName: "job_site_tasks_job_site_id_fkey";
            columns: ["job_site_id"];
            isOneToOne: false;
            referencedRelation: "job_sites";
            referencedColumns: ["id"];
